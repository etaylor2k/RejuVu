...
_magic_number = 5
_modified_time = 1314147298.9263489
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'" size="40" /></td>\n  </tr>\n  <tr>\n    <td colspan="2" height="3px"></td>\n  </tr>\n  <tr>\n    <td>Address</td>\n    <td>&nbsp;</td>\n  </tr>\n  <tr>\n    <td colspan="2"><input name="address" type="text" value="')
        # SOURCE LINE 45
        __M_writer(escape(c.user.address))
        __M_writer(u'" size="40" /></td>\n  </tr>\n  <tr>\n    <td colspan="2" height="3px"></td>\n  </tr>\n  <tr>\n    <td>City</td>\n    <td>&nbsp;</td>\n  </tr>\n  <tr>\n    <td colspan="2"><input name="city" type="text" value="')
        # SOURCE LINE 55
        __M_writer(escape(c.user.city))
        __M_writer(u'" size="40" /></td>\n  </tr>\n  <tr>\n    <td colspan="2" height="3px"></td>\n  </tr>\n  <tr>\n    <td>State</td>\n    <td>Zip Code</td>\n  </tr>\n  <tr>\n    <td><input name="state" type="text" value="')
        # SOURCE LINE 65
        __M_writer(escape(c.user.state))
        __M_writer(u'" size="18" /></td>\n    <td><input name="zip" type="text" value="')
        # SOURCE LINE 66
        __M_writer(escape(c.user.zip))
